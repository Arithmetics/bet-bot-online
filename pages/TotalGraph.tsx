import { useTheme, useMediaQuery, Text, Card, Divider, Badge, Spacer, Grid } from "@geist-ui/react";
...
<<<<<<< HEAD
    ...
    <Card width="500px">
      <Card.Content>
        <Text h4 margin={0}>Total: LA Lakers @ MEM Grizzlies</Text>
        <Spacer h={.5} />
        <Text h5 margin={0}> Grade:&nbsp;
        <Badge type="error">Over 5.6</Badge>
        </Text>
      </Card.Content>
      <Divider  />
      <Card.Content>
          ...
          <ResponsiveLine
            ...
            tooltip={function ({ point }: PointTooltipProps): JSX.Element {
              return (
                  <Grid
                    padding={1}
                    style={{backgroundColor: palette.accents_3}}
                  >
...
>>>>>>> 85893b5aa97ea6f7aa0498a68a74f0e86212bbb6
  );
}
